...
function renderGUI() {
  ...
  divCalc.setAttribute("class", "text-center w-50 position-absolute top-50 start-50 translate-middle");
  ...
  buttons.forEach((el, indx) => {
    ...
    button.setAttribute("style", "--bs-btn-padding-y: 1rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: 2rem");
    button.innerHTML= el;
  ...
  buttonClear.setAttribute("style", "--bs-btn-padding-y: .5rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: 2rem");
